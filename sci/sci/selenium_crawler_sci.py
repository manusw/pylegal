...
class SeleniumCrawler(object):
    ...
    def __init__(self, base_url, exclusion_list, output_file='scilink1.csv', start_url=None):

        assert isinstance(exclusion_list, list), 'Exclusion list - needs to be a list'

        self.browser = webdriver.Chrome('E:/SOFTWARE/chromedriver_win32/chromedriver.exe')  #Add path to your Chromedriver
...
if __name__ == '__main__':
	a = SeleniumCrawler('https://sci.nic.in/', ['?','signin'])
	a.run_crawler()
