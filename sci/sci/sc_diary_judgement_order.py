...
def initialize_judg_order_dic(ta_master_court,ta_diary_num,ta_diary_year,ta_hdn_diary):
    diary_jud_order['ta_master_court'] =ta_master_court
    diary_jud_order['ta_diary_num']=ta_diary_num
    diary_jud_order['ta_diary_year']=ta_diary_year  
    diary_jud_order['ta_hdn_diary']=ta_hdn_diary
...
if result and result.status_code == 200:
    ...
    initialize_judg_order_dic('sc',diary_num,diary_year,hdn_sc_diary_num)    
    table_contents = [] 
...
##        diary_results['diary_listing_details']=table_contents
    diary_jud_order['diary_judg_order']=df[0]
    print(diary_jud_order)     
    print( 'success')
else:
    print( 'fail')
